...
#define QCA8511_PORT_TRUNK_CFG_SWPORT1	0x6820
#define QCA8511_PORT_VLAN_FLTR		0x4054

#define QCA8511_PORT_LRN_CTRL_BASE			0x6404
#define QCA8511_PORT_LRN_CTRL(reg, port) (QCA8511_PORT_LRN_CTRL_BASE + 4 * (reg) + 0x10 * (port))

#define QCA8511_ISO_CTRL_BASE		0xc000
#define QCA8511_ISO_CTRL(reg, entry) (QCA8511_ISO_CTRL_BASE + 4 * (reg) + 0x10 * (entry))
